...
- Conservative DOM-only monitoring of one explicitly selected chat title.
...
Open <http://127.0.0.1:3737> for review. Load `extension/` as an unpacked extension in Chrome, open WhatsApp Web yourself, then use the popup to select the current chat to monitor.
